...
const ModalFormTarea = () => {
   const { id } = useParams();
   const { modal, setModal, setAlerta, alerta, submitTarea, tarea } = useProyectos();
   ...
   const handleSubmit = async (e) => {
      ...
      await submitTarea({ idTarea, nombre, descripcion, prioridad, fechaEntrega, proyecto: id });
                  ...
                  <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                     ...
                     <div className="sm:flex sm:items-start">
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                           ...
                           >
                              {idTarea ? "Guardar cambios" : "Crear tarea"}
                           </Dialog.Title>
                           ...
                           <form className="my-10" onSubmit={handleSubmit}>
                              ...
                              <div className="mb-5">
                                 <label
                                    htmlFor=""
                                    className="text-gray-700 font-bold block text-sm"
                                 >
                                    Prioridad
                                 </label>
                                 <select
